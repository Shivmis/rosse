...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Shivmis/rosse",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/FRIENDSZONEOPX")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/shivang_xd")
